...
class TestAsyncHTTPServer(unittest.TestCase):
    ...
    def test_server_header(self):
        ...
        r = requests.get(self.host + ":" + str(self.port))
    ...
    def test_index_not_found(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/403/')
        self.assertEqual(int(r.status_code), 403)

    def test_file_not_found(self): #+++
        """Absent file returns 404"""
        r = requests.get(self.host + ":" + str(self.port) + "/404/index.html")
        self.assertEqual(int(r.status_code), 404)

    def test_file_in_nested_folders(self): #+++
        """File located in nested folders"""
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/dir2/dir3/quote.txt')
        data = r.content
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(int(length), 62)
        self.assertEqual(len(data), 62)
        self.assertEqual(data.decode(), 'Would you tell me, please, which way I ought to go from here?\n')

    def test_file_with_query_string(self): #+++
        """Slash after filename"""
        r = requests.get(self.host + ":" + str(self.port) + '/404/page.html/')
        self.assertEqual(r.status_code, 404)

    def test_file_with_query_string(self): #+++
        """Query string after filename"""
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/page.html?arg1=value&arg2=value')
        data = r.content
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
    ...
    def test_file_with_spaces(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/space%20in%20name.txt')
        data = r.content
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
    ...
    def test_file_urlencoded(self): #++++
        """Urlencoded filename"""
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/%70%61%67%65%2e%68%74%6d%6c')
        data = r.content
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(int(length), 38)
    ...
    def test_document_root_escaping(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/../../../../../../../../../../../../../etc/passwd')
        self.assertIn(r.status_code, (400, 403, 404))

    def test_file_with_dot_in_name(self): #+++
        """File with two dots in name"""
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/text..txt')
        data = r.content.decode()
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
    ...
    def test_post_method(self): #+++
        ...
        r = requests.post(self.host + ":" + str(self.port) + '/dir1/page.html')
        self.assertIn(int(r.status_code), (400,405))

    def test_head_method(self): #+++
        """Head method support"""
        r = requests.head(self.host + ":" + str(self.port) + '/dir1/page.html')
        data = r.content.decode()
        length = r.headers.get('Content-Length')
        self.assertEqual(r.status_code, 200)
        self.assertEqual(int(length), 38)
    ...
    def test_filetype_html(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/page.html')
        data = r.content
        length = r.headers.get('Content-Length')
    ...
    def test_filetype_css(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/bootstrap.css')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
    ...
    def test_filetype_js(self): ###+++
        """Content-Type for .js"""
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/bootstrap.js')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
    ...
    def test_filetype_jpg(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/cat.jpg')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
    ...
    def test_filetype_jpeg(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/nature.jpeg')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
    ...
    def test_filetype_png(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/logo.png')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
    ...
    def test_filetype_gif(self): #+++
        ...
        r = requests.get(self.host + ":" + str(self.port) + '/dir1/pokemon.gif')
        data = r.content
        length = r.headers.get('Content-Length')
        ctype = r.headers.get('Content-Type')
        self.assertEqual(r.status_code, 200)
